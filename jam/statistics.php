...
<head>
  ...
  <title>StoreManagerHelp - Statystyki Przetwory Warzywne i Owocowe</title>
...
<nav>
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
          ...
          <a class="active" href="statistics.php">Przetwory Warzywne i Owocowe</a>
...
<button class="toggle-button" onclick="toggle()"><h3>Sprzedaż/zakupy</h3></button>
      ...
      <form>
        <h1> Przetwory Warzywne i Owocowe</h1>
        <div class="tab">
        <table class="table">
          <thead>
            <tr>
